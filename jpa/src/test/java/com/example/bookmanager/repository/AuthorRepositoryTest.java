...
class AuthorRepositoryTest {
    ...
    void manyToManyTest() {
        ...
        Author author1 = givenAuthor("grace");
        Author author2 = givenAuthor("elsa");
...
//        System.out.println("books through author: " + authorRepository.findAll().get(0).getBooks());
        ...
        bookRepository.findAll().get(2).getBookAndAuthors().forEach(o -> System.out.println(o.getAuthor())); //여기서 o가 BookAndAuthor
